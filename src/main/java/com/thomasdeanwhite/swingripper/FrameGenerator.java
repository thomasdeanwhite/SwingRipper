...
public class FrameGenerator {
    ...
    private final int MAX_WIDGETS_X = 10;
    private final int MAX_WIDGETS_Y = 10;
    ...
    public JFrame generateRandomFrame() {
        ...
        switch (random.nextInt(3)) {
            ...
            case 1:
                ...
                break;
            case 2:
                jframe.setLayout(new GridLayout(widgetsX, widgetsY, random.nextInt(MAX_PADDING), random.nextInt(MAX_PADDING)));
                LAYOUT = Layout.GRID;
                break;
        }
...
//                        }
                ...
                case 7: //tabs
                    ...
                    tabs.setPreferredSize(new Dimension(200, random.nextInt(200)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            for (int i = 0; i < frames; i++) {
                ...
                if (i == 0) {
                    try {
                        System.out.println("30 seconds to validate that stuff is working!t");
                        Thread.sleep(30000);
                    } catch (InterruptedException e) {
                        e.printStackTrace();
                    }
                ...
                try {
                    rf.rip(i + "-jframe-" + THEME, jf, "swing_generated", "swing_generated", con);
